...
const features = [
  ...
  { name: 'Security', href: '#', description: "Your customers' data will be safe and secure.", icon: '77' },
  {
    name: 'Integrations',
    href: '#',
...
const callsToAction = [
  { name: 'Watch Demo', href: '#', icon: '66' },
  { name: 'Contact Sales', href: '#', icon: '55' }
]
const resources = [
  {
    name: 'Help Center',
  ...
  { name: 'Security', description: 'Understand how we take your privacy seriously.', href: '#', icon: '8' }
]
const recentPosts = [
